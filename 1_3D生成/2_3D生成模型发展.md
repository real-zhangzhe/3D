...
Decoder (DGS / DRF / DM)
     ↓
3D 模型（Gaussian / NeRF / Mesh）
```
#### 3. 资源投入
- 数据：
  - 论文中提到 3D 训练数据都是开源数据，500K 个高质量 3D 资产，image captioning 用的 GPT-4o
- 算力：
